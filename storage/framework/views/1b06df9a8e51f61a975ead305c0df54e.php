...
<?php $component->withAttributes([]); ?>
  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white p-4 rounded-xl shadow-lg">
          ...
          <div class="mt-2 mb-2">
            <a href="<?php echo e(route('admin.kost.create')); ?>" class="bg-orange-500 text-black px-4 py-2 rounded hover:bg-orange-600">Tambah Kost</a>
          </div>
...
<?php endif; ?>
<?php /**PATH /Users/prakosolintang/MyPROJECT/soulcode/PHP/Laravel/kosmabescq/resources/views/admin/kost/index.blade.php ENDPATH**/ ?>