...
<head>
    ...
    <script src="<?php echo e(config('services.midtrans.url')); ?>" data-client-key="<?php echo e(config('services.midtrans.client_key')); ?>"></script>
</head>
<body>
...
<?php endif; ?>
            <?php elseif($reservation->status == 'Dibayar'): ?>
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('customer.reservations.index')); ?>" class="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700">
                        Lihat Reservasi
                    </a>
                </div>
            <?php endif; ?>
