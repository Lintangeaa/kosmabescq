...
<?php $component->withAttributes([]); ?>
  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white p-4 rounded-xl shadow-lg">
          ...
          <div class="mt-2 mb-2">
            <a href="<?php echo e(route('admin.user.create')); ?>" class="bg-orange-500 text-black px-4 py-2 rounded hover:bg-orange-600">Tambah Pengguna</a>
          </div>
                  ...
                  <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                      <tr>
                          ...
                          <td class="border px-4 py-2 text-center">
                              <a href="<?php echo e(route('admin.user.edit', $user->id)); ?>" class="text-blue-500 hover:underline">Edit</a> |
                              <form action="<?php echo e(route('admin.user.destroy', $user->id)); ?>" method="POST" class="inline">
                                  <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/prakosolintang/MyPROJECT/soulcode/PHP/Laravel/kosmabescq/resources/views/admin/user/index.blade.php ENDPATH**/ ?>