        ...
        <div class="bg-white shadow-lg rounded-lg p-8">
            ...
            <div class="mt-6">
                ...
                <div class="flex space-x-4 items-center">
                    <p class="text-gray-600 mt-2"><?php echo e($kost->alamat_lengkap); ?></p>
                    <a href="<?php echo e($kost->gmap); ?>" target="_blank" class="text-blue-600 hover:underline flex items-center">
