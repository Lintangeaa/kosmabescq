...
<head>
    ...
    <script src="{{ config('services.midtrans.url') }}" data-client-key="{{ config('services.midtrans.client_key') }}">
    </script>
</head>
    ...
    <div class="p-12">
        <div class="mb-6">
            <a href="{{ route('customer.reservations.index') }}"
                class="text-blue-600 hover:text-blue-800 text-lg font-semibold flex items-center">
        ...
        <div class="bg-white shadow-lg rounded-lg p-8">
            ...
            <p class="mt-2 text-gray-600">Total Pembayaran: <span id="total-payment" class="font-semibold text-xl">Rp.
                    {{ number_format($reservation->total * $reservation->kost->harga) }}</span></p>
